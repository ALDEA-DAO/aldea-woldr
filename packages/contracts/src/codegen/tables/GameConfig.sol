...
library GameConfig {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "aldea", name: "GameConfig", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462616c64656100000000000000000047616d65436f6e666967000000000000);
   ...
   * @notice Get initialized.
   */
  function get() internal view returns (bool initialized) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get initialized.
   */
  function _get() internal view returns (bool initialized) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set initialized.
   */
  function set(bool initialized) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set initialized.
   */
  function _set(bool initialized) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function encodeStatic(bool initialized) internal pure returns (bytes memory) {
   ...
   */
  function encode(bool initialized) internal pure returns (bytes memory, EncodedLengths, bytes memory) {
    bytes memory _staticData = encodeStatic(initialized);
