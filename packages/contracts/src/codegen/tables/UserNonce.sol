...
library UserNonce {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "aldea", name: "UserNonce", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462616c646561000000000000000000557365724e6f6e636500000000000000);
   ...
   * @notice Get nonce.
   */
  function getNonce(address user) internal view returns (uint256 nonce) {
   ...
   * @notice Get nonce.
   */
  function _getNonce(address user) internal view returns (uint256 nonce) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Get nonce.
   */
  function get(address user) internal view returns (uint256 nonce) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Get nonce.
   */
  function _get(address user) internal view returns (uint256 nonce) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Set nonce.
   */
  function setNonce(address user, uint256 nonce) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Set nonce.
   */
  function _setNonce(address user, uint256 nonce) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Set nonce.
   */
  function set(address user, uint256 nonce) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Set nonce.
   */
  function _set(address user, uint256 nonce) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
